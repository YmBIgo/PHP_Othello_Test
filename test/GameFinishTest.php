...
class GameFinishTest extends TestCase {
	...
	public function testFinishGameCase75() {
		...
		[$is_success, $is_continue] = $this->othello_game->othello->move(0, 0);
		$this->assertSame($is_success, false);
		$this->assertSame($is_continue, false);
	...
	public function testFinishGameCase76() {
	...
	public function testFinishGameCase77() {
	...
	public function testFinishGameCase78() {
		...
		$this->othello_game->inputGame($othello_command);
		$this->othello_game->startGame();
		[$is_success, $is_continue] = $this->othello_game->othello->move(8, 8);
		$this->assertSame($is_success, false);
		$this->assertSame($is_continue, false);
		[$display_board, $candidate_count] = $this->othello_game->othello->getCandidateBoard();
		$expected_board_info =
	...
	public function testFinishGameCase79() {
